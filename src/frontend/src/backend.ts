...
import type { Ebook as _Ebook, ExternalBlob as _ExternalBlob, StripeSessionStatus as _StripeSessionStatus, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addEbook(arg0: Ebook): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addEbook(await to_candid_Ebook_n8(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async completePurchase(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.completePurchase(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteEbook(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getEbookDownloadUrl(arg0: string, arg1: string): Promise<ExternalBlob> {
        if (this.processError) {
            try {
                const result = await this.actor.getEbookDownloadUrl(arg0, arg1);
    ...
    async getEbooks(): Promise<Array<Ebook>> {
        if (this.processError) {
            try {
                const result = await this.actor.getEbooks();
    ...
    async getPurchasedEbooks(arg0: string): Promise<Array<Ebook>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPurchasedEbooks(arg0);
                return from_candid_vec_n16(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateEbook(arg0: Ebook): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateEbook(await to_candid_Ebook_n8(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Ebook_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Ebook): Promise<Ebook> {
...
async function from_candid_record_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        title: value.title,
        coverImageBlob: await from_candid_ExternalBlob_n15(_uploadFile, _downloadFile, value.coverImageBlob),
        pdfBlob: await from_candid_ExternalBlob_n15(_uploadFile, _downloadFile, value.pdfBlob),
...
async function from_candid_vec_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Ebook>): Promise<Array<Ebook>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Ebook_n17(_uploadFile, _downloadFile, x)));
}
async function to_candid_Ebook_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Ebook): Promise<_Ebook> {
...
async function to_candid_record_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        title: value.title,
        coverImageBlob: await to_candid_ExternalBlob_n10(_uploadFile, _downloadFile, value.coverImageBlob),
        pdfBlob: await to_candid_ExternalBlob_n10(_uploadFile, _downloadFile, value.pdfBlob),
        description: value.description,
        priceInCents: value.priceInCents
    };
}
